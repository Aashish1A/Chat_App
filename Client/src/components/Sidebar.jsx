      ...
      {/* User List */}
        <div className='flex flex-col'>
            {userDummyData.map((user, index) => (
                <div key={index} onClick={() => setSelectedUser(user)} className={`flex items-center gap-2 p-2 hover:bg-[#282142] rounded-md cursor-pointer relative max-sm:text-sm ${selectedUser?._id === user._id ? 'bg-[#282142]/50' : ''}`}>
